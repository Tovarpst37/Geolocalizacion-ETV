...
class FormularioAjController
{
    ...
    public function postInsert()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // No hay campo de fecha en el formulario: se usa la fecha/hora del servidor
            ...
            $muerto_Macho = 0;
            $muerto_Hembra = 0;
            $estregarParedes = 'false';
            $aspirar = 'false';
            $succionador = 'false';
            $aguaCambiada = 0; // numérico, no boolean
            ...
            // 2. Guardar el detalle del ajuste de nivel
            if ($id_seguimiento_zoo) {
               ...
               ('$tipoAlimento', '$fechaHora', '$genero', '$obser', 
                ...
                $estregarParedes, $aspirar, $succionador, $nivelAgua, 
                $ph, $temp, 'Sin especificar', $aguaCambiada, 
