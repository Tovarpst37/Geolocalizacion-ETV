...
include_once '../model/ReportesPeces/ReportesPecesModel.php'; // ajusta a la ruta real de tu modelo

use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;

class ReportesPecesController
{

    public function getReportePeces()
    {
        $obj = new ReportesPecesModel();
        ...
        if ($generar) {
            ...
            if (empty($filtroZoocriadero)) {
                ...
                ErrorModal::verError(
                    ...
                    getUrl('ReportesPeces', 'ReportesPeces', 'getReportePeces')
                );
                return;
            }
