...
?>
  ...
  <style>
    ...
    /* Modales flotantes fuera de las tarjetas */
  ...
  <div class="container-fluid px-2 px-md-3 py-2">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3 mb-4">
      <h2 class="module-header-title">
        <i class="bx bx-task"></i> Actividades de Zoocriadero
      </h2>
    ...
    <div class="main-module-container">
      ...
      <!-- Modales fuera del loop principal de tarjetas para evitar el bloqueo del backdrop de Bootstrap -->
