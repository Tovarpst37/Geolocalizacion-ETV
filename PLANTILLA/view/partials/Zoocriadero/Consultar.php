...
/* Modales Flotantes Unificados (Habilitar/Inhabilitar) */
    ...
    <div class="search-box-wrap">
      <form action="index.php" method="GET" class="m-0">
        ...
        <div class="search-box">
          ...
          <input type="text" name="busqueda" placeholder="Buscar zoocriadero..." class="form-control" />
