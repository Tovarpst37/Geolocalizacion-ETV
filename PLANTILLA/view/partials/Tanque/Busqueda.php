...
/* Estilos de Modales Flotantes Rediseñadas */
...
<div class="tank-page container-fluid px-2">
  ...
  <!-- Modales fuera del grid de tarjetas para evitar conflictos con CSS transform/overflow -->
  ...
  <!-- Estado sin resultados estilizado -->
