...
if (!function_exists('terreno_tipoActividad')) {
    function terreno_tipoActividad($nombre)
    {
        ...
        if (strpos($n, 'inspecc') !== false)
            return 'inspeccion';
        // TODO: agregar aquí el resto de actividades de terreno cuando me pases sus formularios
        return null;
    }
}
?>
    ...
    <div class="d-flex justify-content-center">
        <div class="card shadow" style="width: 100%; max-width: 700px;">
            ...
            <div class="card-body p-4">
                <form action="<?php echo getUrl("Seguimientoterreno", "Seguimientoterreno", "postRegistrar") ?>"
                                            ...
                                            <?php if ($tipo === 'inspeccion'): ?>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="datetime-local" class="form-control" id="fecha_horaInsp"
                                                        ...
                                                        max="<?php echo date('Y-m-d\T23:59', strtotime('+1 day')); ?>"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="depositoDetectado"
                                                            id="depositoSi" value="1">
                                                        <label class="form-check-label" for="depositoSi">Sí</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="depositoDetectado"
                                                            id="depositoNo" value="0">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="presenciaLarvas"
                                                            id="larvasSi" value="1">
