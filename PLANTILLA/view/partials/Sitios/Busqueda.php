...
<div class="sites-page container-fluid px-2 px-md-3">
        ...
        <div class="search-box-wrap">
            <form action="index.php" method="GET" class="m-0">
                ...
                <div class="search-box">
                    ...
                    <input type="text" name="busqueda" placeholder="Buscar sitio..." class="form-control" value="<?php echo htmlspecialchars($palabra); ?>" />
    ...
    <?php else: ?>
        ...
        <div class="text-center empty-search-card">
            <div class="empty-search-icon">
                <i class="bx bx-search-alt"></i>
            </div>
            <h5 class="fw-bold text-dark mb-1">Sin resultados</h5>
            <p class="text-muted mb-0">No se encontraron sitios que coincidan con "<strong><?php echo htmlspecialchars($palabra); ?></strong>".</p>
        </div>
