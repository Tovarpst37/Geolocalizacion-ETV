<style>
  ...
  /* Buscador estilo redondeado pill */
  .search-form {
    margin: 0;
    width: 100%;
  }
  ...
  <div class="d-flex flex-column gap-2">
    ...
    <?php else: ?>
      ...
      <div class="empty-card">
        ...
        <h6 class="fw-bold mb-1">No se encontraron resultados</h6>
        <p class="small mb-0">Intenta realizar una búsqueda con un término diferente.</p>
      </div>
    <?php endif; ?>
  </div>
