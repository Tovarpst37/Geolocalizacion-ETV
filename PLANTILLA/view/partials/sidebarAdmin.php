        ...
        <nav class="menu">
            ...
            <ul>
                ...
                <li class="nav-item">
                    ...
                    <ul class="submenu">
                        <li><a href="<?php echo getUrl("FormularioInsp", "FormularioInsp", "getRegistrar"); ?>"><span class="sub-item">Registrar Inspección</span></a></li>
                        <li><a href="<?php echo getUrl("FormularioSiem", "FormularioSiem", "getRegistrar"); ?>"><span class="sub-item">Registrar Siembra</span></a></li>
                        <li><a href="<?php echo getUrl("FormularioSegT", "FormularioSegT", "getRegistrar"); ?>"><span class="sub-item">Registrar Seguimiento</span></a></li>
            ...
            <ul>
                <li class="nav-item">
                    ...
                    <ul class="submenu">
                        <li><a href="#"><span class="sub-item">Seguimiento de actividades</span> <span class="badge-pending">Próximo</span></a></li>
                        <li><a href="#"><span class="sub-item">Peces nacidos/muertos por tanque</span> <span class="badge-pending">Próximo</span></a></li>
                        <li><a href="#"><span class="sub-item">Tanques por zoocriadero</span> <span class="badge-pending">Próximo</span></a></li>
                        ...
                        <li><a href="#"><span class="sub-item">Actividades por auxiliar</span> <span class="badge-pending">Próximo</span></a></li>
