        ...
        <div class="seg-list-item">
          ...
          <div class="seg-info">
            <h6 class="seg-code">
              ...
              <span>Código Seguimiento: <?php echo htmlspecialchars($s['cod_seguimiento']); ?></span>
            </h6>
            <p class="seg-detail">
            ...
            <p class="seg-detail">
              <i class="bx bx-map"></i>
              <span><strong>Sitio:</strong> <?php echo htmlspecialchars($s['nombre_sitio'] ?? 'N/A'); ?></span>
            </p>
            <p class="seg-detail">
              <i class="bx bx-id-card"></i>
              <span><strong>Documento Usuario:</strong> <?php echo htmlspecialchars($s['documento'] ?? 'N/A'); ?></span>
            </p>
          </div>
          ...
          <div class="seg-actions-wrap">
            ...
            <div class="seg-btn-group-custom">
              <a href="<?php echo getUrl("HistorialTerreno", "HistorialTerreno", "getVer", array('id' => $s['id_seguimiento_terreno'])); ?>"
                class="btn btn-white">
