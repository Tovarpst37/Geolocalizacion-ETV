    ...
    <div class="modal-content">
      <form action="<?php echo getUrl('SeguimientoTerreno', 'SeguimientoTerreno', 'postUpdate'); ?>" method="POST">
        <div class="modal-header">
          ...
          <a href="<?php echo getUrl('SeguimientoTerreno', 'SeguimientoTerreno', 'getConsultar') ?>" class="btn btn-close"></a>
        </div>
...
<div class="border-top"></div>
          ...
          ?>
            ...
            <input type="hidden" name="id" value="<?php echo $d['id_seguimiento_terreno']; ?>">
...
<?php }; ?>
        ...
        <div class="modal-footer">
          <a href="<?php echo getUrl('SeguimientoTerreno', 'SeguimientoTerreno', 'getConsultar') ?>" class="btn btn-secondary">Cancelar</a>
